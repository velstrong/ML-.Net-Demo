...
namespace MachineLearning.Services
{
    ...
    {
        public CustomersSegmentator(string filePath)
        {
        ...
        private static string TrainedModelFile => Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "clusterdata.model");
        ...
        private static ITransformer TrainModel
        {
            get
            {
                ...
                return LoadModel(_basepath+ "/clusterdata.model");
            }
            set
            {
                _transformer = value;
                SaveModel(_transformer, _basepath + "/clusterdata.model");
            }
        }
